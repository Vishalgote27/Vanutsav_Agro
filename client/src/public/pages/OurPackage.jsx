...
const attractions = [
...

    {
        ...
        images: [
            ...
            "https://vanutsavagrotourism.com/wp-content/uploads/2024/07/TENT2.jpg",
    ...
    },
    {
        ...
        images: [
            ...
            "https://vanutsavagrotourism.com/wp-content/uploads/2024/07/BARBEQUE-1.jpg",
        ],
    },
    {
    ...
    return (
        <>
            ...
            <div className="text-center py-8 ">
                <p className="text-2xl lg:text-4xl font-medium text-green-600 mb-2">Plan Your Trip To</p>
