...
const About = () => {
    ...
    const cards = [
        ...
        { id: 3, img: '/vanutsav/IMG_5709.PNG', text: 'Camp Fire' },
        { id: 4, img: '/vanutsav/403472182_238512965910037_2746475499969933279_n.jpg', text: 'Camping' },
    ];
    ...
    return <>
        ...
        <section className="mt-24 py-20 relative bg-fixed bg-cover" style={{ backgroundImage: `url('/vanutsav/59faac2b-5cc4-4bdf-9b5e-62c56ead295e.jpg')` }}>
            ...
            <div className="container mx-auto flex px-5 my-5 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <p className="mb-8 leading-relaxed text-start">
                        Welcome to Van Utsav Agro Tourism, the perfect place for a unique and immersive experience in nature. Located in the peaceful landscapes of Murshadkuli, A’Bad, our destination offers a wonderful mix of nature, adventure, and culture.
                    </p>
                    <p className="mb-8 leading-relaxed text-start">
        ...
        <div data-aos="fade-up" className="relative bg-cover bg-center bg-no-repeat mb-5 " style={{ backgroundImage: `url('https://vanutsavagrotourism.com/wp-content/uploads/2024/07/b277f573-7572-4270-8056-a8dd04d57123.jpg')` }}>
