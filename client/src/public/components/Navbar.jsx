            ...
            {isOpen && (
                <div className="md:hidden">
                    ...
                    <Link to={"/gallary"} onClick={toggleMenu}>
                        <p
                            className="block text-gray-800 hover:text-green-700 px-4 py-2 hover:text-white  hover:bg-green-500"
                        >
                    ...
                    <div className="text-center">
                        <button className="w-52 bg-green-600 text-white px-4 py-2 mt-2 rounded mb-2">
                            <Link to={"/contact"}>
                                Book Now
                            </Link>
                        </button>
