        ...
        <section data-aos="fade-up" className="text-gray-600 body-font py-6  ">
            <div className="container mx-auto flex flex-col md:flex-row items-center md:space-x-12 px-5">
                ...
                <div className="lg:flex-grow md:w-1/2 flex flex-col md:items-start md:text-left items-center text-center h-full">
                    ...
                    <p className="mb-6 leading-relaxed text-start ">Welcome to Van Utsav Agro Tourism, the perfect place for a unique and enjoyable agro-tourism experience. Located in the peaceful surroundings of Murshadkuli, A'Bad, we provide a wonderful mix of nature, adventure, and culture.</p>
